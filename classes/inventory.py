...
class InventoryManager():
    def __init__(self, game):
        ...
        pos = (Settings.window_width // 2 - Settings.inventory_size[0] // 2, Settings.window_height // 2 - Settings.inventory_size[1] // 2 + 15)
    ...
    def init_grid(self, start_pos, cols, rows, offset):
        ...
        for row in range(rows):
            for col in range(cols):
                pos = (x * Settings.inventory_slot_size[0] + offset * x + start_pos[0] + max_offset[0], y * Settings.inventory_slot_size[1] + offset * y + start_pos[1] + max_offset[1])
